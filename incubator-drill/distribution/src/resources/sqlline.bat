...
set DRILL_SHELL_JAVA_OPTS=%DRILL_SHELL_JAVA_OPTS% -agentlib:jdwp=transport=dt_socket,server=y,address=21980,suspend=n -Dlog.path="%DRILL_LOG_DIR%\sqlline.log"
