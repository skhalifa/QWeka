...
@JsonTypeName("using")
public class Using extends LogicalOperatorBase {
  ...
  @JsonCreator
  public Using(@JsonProperty("left") LogicalOperator left, @JsonProperty("right") LogicalOperator right,
      @JsonProperty("conditions") JoinCondition[] conditions, @JsonProperty("type") String type) {
    this(left, right, conditions, resolve(type));
  }


  public Using(LogicalOperator left, @JsonProperty("right") LogicalOperator right, JoinCondition[] conditions, JoinRelType type) {
    super();
  ...
  public <T, X, E extends Throwable> T accept(LogicalVisitor<T, X, E> logicalVisitor, X value) throws E {
    return null;//logicalVisitor.visitJoin(this, value);
  }
  ...
  public static class Builder extends AbstractBuilder<Using>{
    ...
    public Using build() {
      ...
      return new Using(left, right, conditions.toArray(new JoinCondition[conditions.size()]), type);
    }
